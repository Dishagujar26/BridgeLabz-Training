...
public class ContactBookApp {
	...
	static void addContact() {
		...
		contacts.add(new Contact(fn, ln, phone, email, new Address(city, state, zip)));
	...
	static void searchContact() {
		...
		for (Contact c : contacts) {
			if (c.getAddress().getCity().equalsIgnoreCase(key) || c.getAddress().getState().equalsIgnoreCase(key)) {
